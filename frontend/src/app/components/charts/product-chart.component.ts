...
@Component({
  ...
  template: `
    <div class="bg-slate-50 dark:bg-gray-800 rounded-xl p1 m-2  shadow-lg mb-5">
      <h3 class="text-xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">Product Quantities</h3>
...
export class ProductChartComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if ((changes['chartData'] || changes['chartLabels']) && this.isBrowser) {
      console.log('Product chart received new data:', {
